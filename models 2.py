...
class Google(db.Model):
    ...
    facebook_c_url = db.Column(db.String(200))
    facebook_c_likes = db.Column(db.Integer)
    googleplus_c_url = db.Column(db.String(200))
    googleplus_c_likes = db.Column(db.Integer)
    twitter_c_url = db.Column(db.String(200))
    twitter_c_likes = db.Column(db.Integer)
